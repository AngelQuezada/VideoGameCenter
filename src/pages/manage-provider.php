...
$cant = $provider->quantityProviders();
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <div class="row">
    <div class="col-sm">
        <div class="card" id="admin" style="width:250px">
            ...
            <div class="card-body">
              <h4 class="card-title">Quantity Providers</h4>
              <?php
                echo "<p class='card-text'>Quantity providers are: $cant</p>";
              ?>
            </div>
        </div><!-- card -->
    </div>
