...
$cant = $category->quantityCategories();
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="container">
  <div class="row">
    <div class="col-sm">
        <div class="card" id="admin" style="width:270px">
            <img class="card-img-top" src="">
            <div class="card-body">
              <h4 class="card-title">Quantity Categories</h4>
              <?php
                echo "<p class='card-text'>Quantity Categories are: $cant</p>";
              ?>
            </div>
        </div><!-- card -->
    </div>
